...
/*		  boolean radio_no=q_recipient_have_influence.isSelected(); 
		  if(radio_no == false)  { 
		  		q_recipient_have_influence.click(); 
		 }
		 */
...
/*		  WebElement button= driver.findElement(By.xpath("//input[@id='q_recipient_have_influence-no']"));
		  new Actions(driver).moveToElement(button).click().build().perform(); */
		  
/*		WebElement radio1 = driver.findElement(By.xpath("//input[@id='q_recipient_have_influence-no']"));
...
/*		List<WebElement> radioGrp = driver.findElements(By.name("q_recipient_have_influence"));
		radioGrp.get(1).click(); */
		
/*		WebElement element = driver.findElement(By.cssSelector("input[id='q_recipient_have_influence-no']"));
